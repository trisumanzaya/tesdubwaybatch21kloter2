...
$datas = query("SELECT *, merk.name as merk_name FROM cycle JOIN merk ON merk.id = cycle.id_merk");
...
<body>
  <div class="container">
    <div class="d-flex flex-row justify-content-between" style="margin-bottom: 100px">
      ...
      <div class="mt-2">
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalMusic">My Order</button>
      </div>
    </div>
  </div>
